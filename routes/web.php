...
use App\Http\Controllers\DataPesertaController1;
...
Route::prefix('datapeserta1')->group(function(){
    Route::get('/view',[DataPesertaController1::class, 'DataPeserta1View'])->name('datapeserta1.view');
    Route::get('/add',[DataPesertaController1::class, 'DataPeserta1Add'])->name('datapeserta1.add');
    Route::post('/store',[DataPesertaController1::class, 'DataPeserta1Store'])->name('datapeserta1.store');
    Route::get('/edit/{id}',[DataPesertaController1::class, 'DataPeserta1Edit'])->name('datapeserta1.edit');
    Route::post('/update/{id}',[DataPesertaController1::class, 'DataPeserta1Update'])->name('datapeserta1.update');
    Route::get('/delete/{id}',[DataPesertaController1::class, 'DataPeserta1Delete'])->name('datapeserta1.delete');
}); 
